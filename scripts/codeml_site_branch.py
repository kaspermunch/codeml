...
cml.set_options(model=2) #  0:one-w for all branches; 2: w’s for branches
cml.set_options(NSsites=[2]) #  0:one-ratio; 1:neutral; 2:selection; 3:discrete; 7:beta; 8:beta&w
